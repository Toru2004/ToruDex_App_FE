...
import 'package:torudex/api/group_api.dart';
import 'package:torudex/config.dart';
import 'package:torudex/screen/groupPage/create_group_post_page.dart';
import 'package:torudex/screen/groupPage/group_management_page.dart';
  ...
  Future<String?> uploadToCloudinary(File imageFile) async {
    try {
      final response = await cloudinary.uploadFile(
        ...
        folder:
            'ToruDex/CommunityGroups/${FirebaseAuth.instance.currentUser?.uid}', // thư mục lưu trữ trên Cloudinary
        fileName:
