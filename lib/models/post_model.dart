...
class PostModel {
  ...
  /// ✅ Helper parse createdAt từ Timestamp hoặc String
  ...
  /// Tạo từ Map chung (Firestore hoặc API)
  ...
  /// Tạo từ JSON API (Elasticsearch, REST API)
